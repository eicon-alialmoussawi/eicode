...
(function ($) {
        ...
        if (jQuery('body').hasClass('sticky-header')) {
            ...
            if (window_y > start_y) {
                if (!(jQuery('#Top_bar').hasClass('is-sticky'))) {
                    ...
                    jQuery('#Top_bar').add("body").addClass('is-sticky').css('top', -60).animate({
                ...
                if (jQuery('#Top_bar').hasClass('is-sticky')) {
                    ...
                    jQuery('#Top_bar').add("body").removeClass('is-sticky').css('top', topBarTop);
                }
            }
        }
    }
    ...
    jQuery(document).ready(function () {
        ...
        function sideSlide() {
            const rtl = $("html").attr("dir").toLowerCase() === "rtl";
            var slide = $('#Side_slide');
            var overlay = $('#body_overlay');
            var ss_mobile_init_W = mobile_init_W;
            var pos = rtl ? "left" : 'right';
            ...
            var constructor = function () {
                ...
                if (!slide.hasClass('enabled')) {
                    ...
                    // console.log("constructor:", $("nav#menu").length)
            ...
            var destructor = function () {
                ...
                if (slide.hasClass('enabled')) {
                    ...
                    close();
                    console.log($("nav#menu").length)
                    if (!$("#Top_bar .menu_wrapper nav#menu").length) $('nav#menu').detach().prependTo('#Top_bar .menu_wrapper');
            ...
            $("body").on("click", "#Side_slide .close", function (e) {
                e.preventDefault();
                close();
            })
    ...
    jQuery(window).scroll(function () {
        ...
        document.querySelector("#Top_bar").classList.toggle("is-sticky", st > 100)
    });
    ...
    function mfnSliderBlog() {
        ...
        const callback = function (mutationsList, observer) {
            ...
            for (const mutation of mutationsList) {
                if (mutation.type === 'childList') {
                    ...
                    timeout = setTimeout(() => initSlider(mutation.target), 100);
                }
        ...
        const initSlider = function (s) {
            // Init carouFredSel
            jQuery(s).carouFredSel({
                circular: true,
                responsive: true,
                items: {
                    width: 380,
    ...
    // code by Karim Sabbagh, all rights reserved ©
    function menuOverflow() {
        const lang = document.querySelector("html").lang;
        const mediaQueryList = matchMedia("(max-width: 1240px)");
        let isMobile = mediaQueryList.matches;
        mediaQueryList.addEventListener("change", mql => isMobile = mql.matches)
        if (!document.querySelector("#Header_wrapper.public-page")) {
            // inner pages menu observer
            const options = {
                root: null,
                rootMargin: "0px",
                threshold: 0
            ...
            const observer = new IntersectionObserver(entries => {
                entries.forEach(e => {
                    e.target.style.transform = e.isIntersecting ? e.intersectionRatio < 1 && !isMobile ? `translatex(${lang === "ar" ? 200 : -200}%)` : "none" : "none"
                })
            }, options);

            observer.observe(document.querySelector("#Top_bar .menu li ul li ul"))
        }
    }
