...
const Glossary = (props) => {
    ...
    const getUserPermissions = async () => {
          APIFunctions.getUserPermissions("Glossary")
              .then((response) => {
                  var _permissions = [];
                  var result = response.data;
                  result.map((element) => {
                      if (element.pageUrl == "Glossary") {
    ...
    AlertConfirm('Are you sure you want to delete ?')
      .then(res => {
        ...
        if (res.value) {
          ...
          LoadingAlert("Show");
          APIFunctions.deleteGlossary(id)
            .then((response) => {
    ...
    const save = () => {
        ...
        if (edited.nameEn == "" || edited.nameEn == null
            || edited.nameAr == "" || edited.nameAr == null
            || edited.nameFr == "" || edited.nameFr == null
        ...
        APIFunctions.saveGlossary(edited)
            .then((response) => {
                if (!response.data) {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                Header: "Word In Arabic",
                accessor: "nameAr",
            },
            {
                Header: "Word In French",
                accessor: "nameFr",
            },
            {
                Header: "Definition In English",
                accessor: "descriptionEn",
            },
            {
                Header: "Definition In Arabic",
                accessor: "descriptionAr",
            },
            {
                Header: "Definition In French",
                ...
                <Modal.Body>
                    <div className="row mb-3">
                        <div class="col-6 bottommargin-sm">
                            <label for="template-contactform-name">Word In English<small className="text-danger">*</small></label>
                            <input
                                type="text"
                                id="txtNameEn"
                                name="template-contactform-name"
                                value={edited.nameEn}
                                onChange={(e) => { setEdited({ ...edited, nameEn: e.target.value }) }}
                                class="form-control required"
                            />
                        </div>
                        <div class="col-6 bottommargin-sm">
                            <label for="template-contactform-name">Word In Arabic<small className="text-danger">*</small></label>
                            <input
                                type="text"
                                id="txtNameEn"
                                name="template-contactform-name"
                                value={edited.nameAr}
                                onChange={(e) => { setEdited({ ...edited, nameAr: e.target.value }) }}
                                class="form-control required"
                            />
                        </div>
                    </div>
                    ...
                    <div className="row mb-3">
                        <div class="col-6 bottommargin-sm">
                            <label for="template-contactform-name">Word In French<small className="text-danger">*</small></label>
                            <input
                                type="text"
                                id="txtNameEn"
                                name="template-contactform-name"
                                value={edited.nameFr}
                                class="form-control required"
                                onChange={(e) => { setEdited({ ...edited, nameFr: e.target.value }) }}
                    ...
                    <div class="col-12 bottommargin-sm">
                        <label for="template-contactform-name">Definition In English<small className="text-danger">*</small></label>
                        <textarea
                            type="text"
                            id="txtNameEn"
                            name="template-contactform-name"
                    ...
                    <div class="col-12 bottommargin-sm">
                        <label for="template-contactform-name">Definition In Arabic<small className="text-danger">*</small></label>
                        <textarea
                            type="text"
                            id="txtNameEn"
                            name="template-contactform-name"
                    ...
                    <div class="col-12 bottommargin-sm">
                        <label for="template-contactform-name">Definition In French<small className="text-danger">*</small></label>
                        <textarea
                            type="text"
                            id="txtNameEn"
                            name="template-contactform-name"
